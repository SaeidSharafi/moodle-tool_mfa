...
$string['settings:window'] = 'TOTP پتجره تایید';
...
$string['setupfactor'] = 'تنظیمات احراز هویت';
$string['setupfactor:account'] = 'حساب کاربری:';
$string['setupfactor:link'] = '<b> یا </b> باز کردن اپلیکیشن موبایل:';
$string['setupfactor:link_help'] = 'در صورتی که ای نصفحه را از طریق موبایل مشاهده میکنید و نرم افزار google authenticator را نصب کرده‌اید از اینلینک استفاده کنید.';
$string['setupfactor:linklabel'] = 'باز کردن اپلیکیشنی که در این دستگاه از قبل نصب شده است';
$string['setupfactor:mode'] = 'حالت:';
...
$string['setupfactor:enter_help'] = 'در صورتی که میخواهید به صورت دستی کد را وارد کنید مطمین شوید نامی که در اپلیکیشن وارد کنید بعدا قابل  تشیخص باشد، به عنوان مثال نام سایت. گزینه mode بر روی time-based باشد.';
$string['setupfactor:key'] = 'کلید مخفی: ';
...
$string['factorsetup'] = 'تنظیم اپلیکیشن';
